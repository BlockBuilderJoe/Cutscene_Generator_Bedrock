...
entity_tag = "tag" # tag of the entity to move.
...
for i in range(num_blocks): 
    ...
    command.append(f"execute if score @p count matches {tick_count} run tp @e[tag={entity_tag}] {x} {y} {z}")
...
#generates a function that will trigger the cutscene.s
